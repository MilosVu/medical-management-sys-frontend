                ...
                <div className="row">
                    <div className="col-md-3">
                        <div className="list-group" id="list-tab" role="tablist">
                            ...
                            <a className="list-group-item list-group-item-action" href="/doctors" id="list-app-list" role="tab" data-toggle="list" aria-controls="home" aria-expanded="false">Doctor list</a>
                            <a className="list-group-item list-group-item-action" href="/patients" id="list-pres-list" role="tab" data-toggle="list" aria-controls="home" aria-expanded="false"> Patients List</a>
                            <a className="list-group-item list-group-item-action" href="/examinations" id="list-pres-list" role="tab" data-toggle="list" aria-controls="home" aria-expanded="false"> Examinations List</a>
                        </div>
                    </div>
